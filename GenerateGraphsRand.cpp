...
int main()
{
    ...
    const string fileOutputName = "Graphs5.json"; 
    ...
    vector<vector<int>> unUsedPerms;            //Indeksy nie użytych kombinacji 
        ...
        {   
            ...
            if(nextC)
            {
                ...
                if(AllCombinChecked)        //Czy wszystkie kombinacje zostały sprawdzone
                {
                    ...
                    {
                        unUsedPerms[x].push_back(i);
                    }
                    combinationIndex[x]=rand()%unUsedPerms[x].size();           //Losowanie kombinacji do sprawdzenia
                    combinationIndex[x]=unUsedPerms[x][combinationIndex[x]];
                    unUsedPerms[x] = Remove(unUsedPerms[x],combinationIndex[x]);
                }
